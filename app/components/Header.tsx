    ...
    <div className="headerContainer">
      <header>
        <div className="HeaderBoxOne">
          <nav>
            <ul className="navBar">
              ...
              <li>
                <a href="/plans" className="fontFamily">
                  Plan
                </a>
              </li>
              <li>
                <a href="#Gallery" className="fontFamily">
                  Gallery
                </a>
              </li>
              <li>
                <a href="#Services" className="fontFamily">
                  Services
                </a>
              </li>
              <li>
                <a href="/About" className="fontFamily">
                  About
                </a>
              </li>
            </ul>
        ...
        <div className="HeaderBoxTwo">
          <Image src={background} className="HeaderImg" alt=""></Image>
        </div>
      </header>
    </div>
  );
